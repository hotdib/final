 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (document.querySelector(".header__open")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".header__open")) {
                    bodyLockToggle();
        ...
        function pageNavigation() {
            ...
            function scrollFunction() {
                if (document.body.scrollTop > 770 || document.documentElement.scrollTop > 770) mybutton.style.display = "block"; else mybutton.style.display = "none";
            }
